...
- The **Graph View** in the **Standard Window** is similar, but since there is no **Branches View**, you can only visualize the current branch or all branches when the 'My History' tab is open.
