...
- If one or more [Hosting Provider integrations](../../Integrations/Cloning-Integration.md) have been configured, use the navigation to select an available repository.
