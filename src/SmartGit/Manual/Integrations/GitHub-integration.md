...
Be sure to also **Grant Access** to all organizations, otherwise the corresponding organization repositories won't show up/can't be accessed in SmartGit.
...
> If you need to repeat the Authorization process outlined above, you should first **Revoke** access on GitHub and start over.
