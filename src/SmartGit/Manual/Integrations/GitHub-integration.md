...
This will open up your default web browser where you will need to confirm to GitHub that you authorize SmartGit for access to GitHub.

#### Note
> Be sure to also **Grant Access** to each required organization, otherwise the corresponding organization repositories won't show up/can't be accessed in SmartGit.
...
This code will be used to create an *application access token* which will be used to automatically populate the **Token** field.
...
> Once you have authorized SmartGit to integrate with GitHub, you can manage access under GitHub **Settings**, **Applications \| Authorized OAuth Apps**.
