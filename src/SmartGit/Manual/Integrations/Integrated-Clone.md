...
In the below diagram, the the SmartGit user has configured integrations to multiple Hosting Providers, and a list of available repositories is displayed beneath each organizational folder:
