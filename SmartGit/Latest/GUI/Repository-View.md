# The Repository View in SmartGit

The *Repository View* shows a list of repositories known to SmartGit on the local computer, allowing you to open an existing repository, 
and shows you which repository(ies) are currently open by a **bold** highlight.
