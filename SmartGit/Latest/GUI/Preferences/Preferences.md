...
**TODO** Need to document 3 x Log Checkbox functions.
...
SmartGit supports a wide number of external tool configurations. Refer to the [Tools](Tools.md) for more details.

**TODO** 'Diff Tools and Conflict Solvers belong under 'Tools' or perhaps separate article altogether.
